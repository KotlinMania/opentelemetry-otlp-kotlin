...
This file is the quick-reference operating contract for opentelemetry-otlp-kotlin. The longer
...
opentelemetry-otlp-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`opentelemetry-otlp`](https://crates.io/crates/opentelemetry-otlp). Upstream Rust is the behavioral oracle while the
