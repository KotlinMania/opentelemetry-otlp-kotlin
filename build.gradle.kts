...
kotlin {
    ...
    val xcf = XCFramework("OpentelemetryOtlp")

    macosArm64 {
        binaries.framework { baseName = "OpentelemetryOtlp"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "OpentelemetryOtlp"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "OpentelemetryOtlp"
        flattenPackage = "io.github.kotlinmania.opentelemetryotlp"
    }

    android {
        namespace = "io.github.kotlinmania.opentelemetryotlp"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "opentelemetry-otlp-kotlin", version.toString())

    pom {
        name.set("opentelemetry-otlp-kotlin")
        description.set("Kotlin Multiplatform port of open-telemetry/opentelemetry-rust - Exporter for the OpenTelemetry Collector")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/opentelemetry-otlp-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/opentelemetry-otlp-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/opentelemetry-otlp-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/opentelemetry-otlp-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleOpentelemetryOtlpXCFramework",
    "assembleOpentelemetryOtlpDebugXCFramework",
    "assembleOpentelemetryOtlpReleaseXCFramework",
    "assembleDebugIosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseIosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugMacosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseMacosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugTvosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseTvosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugWatchosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseWatchosFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForOpentelemetryOtlpXCFramework",
