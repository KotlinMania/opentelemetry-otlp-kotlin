# opentelemetry-otlp-kotlin in Kotlin

[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fopentelemetry--otlp--kotlin-blue.svg)](https://github.com/KotlinMania/opentelemetry-otlp-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/opentelemetry-otlp-kotlin)](https://central.sonatype.com/artifact/io.github.kotlinmania/opentelemetry-otlp-kotlin)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/opentelemetry-otlp-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/opentelemetry-otlp-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp).

**Original Project:** This port is based on [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
## Upstream README — `open-telemetry/opentelemetry-rust`

> The text below is reproduced and lightly edited from [`https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
* [opentelemetry-appender-log](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/opentelemetry-appender-log/README.md)
* [opentelemetry-appender-tracing](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/opentelemetry-appender-tracing/README.md)
...
[here](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/VERSIONING.md).

## Getting Started

If you are new to OpenTelemetry, start with the getting started examples for
[logs](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/examples/logs-basic/README.md),
[metrics](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/examples/metrics-basic/README.md) or
[traces](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/examples/tracing-grpc/README.md). This example demonstrates how to
...
HTTP](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/opentelemetry-otlp/examples/basic-otlp-http/README.md) and the [OTLP
Example - gRPC](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/opentelemetry-otlp/examples/basic-otlp/README.md).

Additional examples for various integration patterns can be found in the
[examples](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/examples) directory.
...
See the [contributing file](https://github.com/open-telemetry/opentelemetry-rust/blob/HEAD/CONTRIBUTING.md).
...
```kotlin
dependencies {
    implementation("io.github.kotlinmania:opentelemetry-otlp-kotlin:0.1.0-SNAPSHOT")
}
```
...
This Kotlin port is distributed under the same Apache-2.0 license as the upstream [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.

Original work copyrighted by the opentelemetry-rust authors.  
Kotlin port: Copyright (c) 2026 Sydney Renee and The Solace Project.

### Acknowledgments

Thanks to the [`open-telemetry/opentelemetry-rust`](https://github.com/open-telemetry/opentelemetry-rust/tree/main/opentelemetry-otlp) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
